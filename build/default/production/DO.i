...
void DO_Init(void)
{
    ...
    ((((PORTC))) = (((PORTC)) & (~(1 << ((5)))))|(OFF << ((5))));
    ((((PORTC))) = (((PORTC)) & (~(1 << ((2)))))|(OFF << ((2))));
    ((((PORTB))) = (((PORTB)) & (~(1 << ((7)))))|(OFF << ((7))));
    ((((PORTB))) = (((PORTB)) & (~(1 << ((6)))))|(OFF << ((6))));
...
void DO_SetState(tDO device ,tDO_State state)
{
    ...
    {
        case Heater :
            ((((PORTC))) = (((PORTC)) & (~(1 << ((5)))))|(state << ((5))));
            break;

        case Motor :
            ((((PORTC))) = (((PORTC)) & (~(1 << ((2)))))|(state << ((2))));
            break;
