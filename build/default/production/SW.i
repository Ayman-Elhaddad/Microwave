...
void SW_Init(tSW sw)
{
    ...
    switch(sw)
    {
        case DOOR_SW:
            ...
            SWs_Info[DOOR_SW].sw_samples[0] = (1);
            SWs_Info[DOOR_SW].sw_samples[1] = (1);
        ...
        case WEIGHT_SW:
            ...
            SWs_Info[WEIGHT_SW].sw_samples[0] = (1);
            SWs_Info[WEIGHT_SW].sw_samples[1] = (1);
...
void SW_Update(void)
{
    ...
    for (index = DOOR_SW; index < (2); index++)
    {
        ...
        if (index == DOOR_SW)
        {
            SWs_Info[index].sw_samples[1] = (((((PORTB))) & (1 << ((3)))) >> (((3))));
        }
        else if (index == WEIGHT_SW)
        {
            SWs_Info[index].sw_samples[1] = (((((PORTB))) & (1 << ((4)))) >> (((4))));
        }
        else
        {
