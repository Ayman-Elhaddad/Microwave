...
/* PORTB pull-up resistros*/

#define PORTB_PULLUP_ENABLE  (RBPU = 0)
#define PORTB_PULLUP_DISABLE  (RBPU = 1)
...
/* Timer 0 macros */
#define TMR_SET_PRESCALER_8 	T0PS2 = 0;\
								T0PS1 = 1;\
								T0PS0 = 0;\
								PSA = 0
...
#define TMR_UPDATE_REGISTER(TIME)		(TMR0 = 256 -(TIME * 1000 )/(4*.125*8)) 

#define TMR_ENABLE_INTERRUPT	(TMR0IE = 1)
#define GLOBAL_INTERRUPT_ENABLE	(GIE = 1)

#define TMR_ENABLE       (TMR0ON = 1)
#define TMR_DISABLE      (TMR0ON = 0)

#define TMR_ENABLE_CLOCK		(T0CS = 0)
#define TMR_DISABLE_CLOCK		(T0CS = 1)

#define TMR_8_BIT_MODE           (T08BIT = 1)
#define TMR_16_BIT_MODE          (T08BIT = 0)
